...
#include "../Game/dialogs/saveloaddialog.h"
...
static const char qt_meta_stringdata_SaveLoadDialog[] = {
    "SaveLoadDialog\0\0str\0click(QListWidgetItem*)\0"
    "action(QListWidgetItem*)\0action()\0"
};

const QMetaObject SaveLoadDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SaveLoadDialog,
      qt_meta_data_SaveLoadDialog, 0 }
};
...
int SaveLoadDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: click((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 1: action((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 2: action(); break;
        default: ;
        }
        _id -= 3;
